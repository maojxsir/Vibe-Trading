...
export const humanoidConfig: IndustryChainConfig = {
  title: "人形机器人",
  agentModuleName: "人形机器人",
  storageKey: "module-stocks:humanoid",
  meta: [
    { text: "基于 170 篇 2026 研报·覆盖 19 家核心标的", plain: true },
    { text: "数据日期: 2026-05-25", tone: "primary" },
    { text: "市场数据: 17:34:21 更新", tone: "success" },
  ],
  tabs: [
  ...
  overviewTitle: "人形机器人产业链总览",
  valuationSubtitle: "19 家核心标的的实时估值 | 数据更新: 2026-05-23 (最近交易日)",
  valuation,
  sections,
  moduleStocks,
  specialTabs: { valuation: "估值全景" },
};

export const humanoidSeed = humanoidConfig;
